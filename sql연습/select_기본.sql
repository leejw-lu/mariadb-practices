...
-- 예제5: titles 테이블에서 모든 직급의 이름을 한번씩 출력
...
select concat(first_name, ' ', last_name) as '이름', 
	gender as '성별', 
    hire_date as '입사일' 
from employees where hire_date < '1991-01-01';
...
-- IN 연산자
-- 예제3: dept_emp 테이블에서 부서 번호아 d005나 d009에 속한 사원의 사번, 부서번호 출력
